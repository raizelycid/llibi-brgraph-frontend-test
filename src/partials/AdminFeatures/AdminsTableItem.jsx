  ...
  return (
    <tbody className="text-sm">
      ...
      {props.permissions.join(', ')}
        ...
        <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
        <button className="btn bg-indigo-500 hover:bg-indigo-600 text-white">Update Permissions</button>
        {' '}
        <button className="btn bg-rose-500 hover:bg-rose-600 text-white">Remove User</button>
        </td>
