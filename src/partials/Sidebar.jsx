        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <h3 className="text-xs uppercase text-slate-500 font-semibold pl-3">
              ...
              <span className="lg:hidden lg:sidebar-expanded:block 2xl:block">User Features</span>
            </h3>
            <ul>
            {/* User Features */}
                ...
                return (
                  <React.Fragment>
                    ...
                    <div className="flex items-center justify-between">
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-report-analytics" width={sidebarOpen ? "2rem" : "1.5rem"} height={sidebarOpen ? "2.5rem" : "2rem"} viewBox="0 0 24 24" stroke-width="2.25" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
          ...
          <div>
            ...
            <h3 className="text-xs uppercase text-slate-500 font-semibold pl-3">
              ...
              <span className="lg:hidden lg:sidebar-expanded:block 2xl:block">Admin Features</span>
            </h3>
            <ul>
            {/* User Features */}
              ...
              {(handleClick, open) => {
                return (
                  <React.Fragment>
                    ...
                    <div className="flex items-center justify-between">
                          <div className="flex items-center">
                          <img src={suitcase} alt="suitcase" className="w-6 h-6" />
