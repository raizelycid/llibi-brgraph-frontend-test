        ...
        <div ref={modalContent} className={`bg-white dark:bg-slate-800 rounded shadow-lg overflow-auto max-w-lg w-full max-h-full`}>
          ...
          <div className="px-5 py-3 border-b border-slate-200 dark:border-slate-700">
            <div className="flex justify-between items-center">
              ...
              <button className="text-slate-400 dark:text-slate-500 hover:text-slate-500 dark:hover:text-slate-400" onClick={(e) => { e.stopPropagation(); setModalOpen(false); resetModal() }}>
